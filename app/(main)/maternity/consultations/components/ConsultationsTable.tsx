...
interface ConsultationsTableProps {
  data: MaternityConsultation[];
  onRowClick: (consultation: MaternityConsultation) => void;
  onEdit: (consultation: MaternityConsultation) => void;
  onRefresh: () => void;
}
...
export const columns = (
  onEdit: (consultation: MaternityConsultation) => void,
  onRefresh: () => void
): ColumnDef<MaternityConsultation>[] => [
  {
    accessorKey: "name",
    header: "Patient",
    cell: ({ row }) => {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link
                href={`/maternity/consultations/${consultation.consultationId}`}>
            ...
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  onClick={() =>
                    router.push(
                      `/maternity/consultations/${row.original.consultationId}`
                    )
                  }
