...
export default function HospitalizationDetailPage() {
  ...
  const [hospitalization, setHospitalization] = useState<MaternityHospitalization | null>(null);
  ...
  async function loadHospitalization() {
    ...
    if (error) {
      ...
      router.push("/maternity/hospitalizations");
      return;
    }
  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `hospitalization_${hospitalization.hospitalizationId}_${format(new Date(), 'yyyy-MM-dd')}.pdf`;
    ...
    return (
      <div className="container mx-auto py-8 px-4">
        <div className="text-center">
          ...
          <Link href="/maternity/hospitalizations">
            <Button>
