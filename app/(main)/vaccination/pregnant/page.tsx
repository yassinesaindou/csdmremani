...
export default function VaccinationPregnantPage() {
  const [vaccinations, setVaccinations] = useState<VaccinationFemmeEnceinte[]>([]);
  const [loading, setLoading] = useState(true);
  const [selectedVaccination, setSelectedVaccination] = useState<VaccinationFemmeEnceinte | null>(null);
  const [detailModalOpen, setDetailModalOpen] = useState(false);
  const [formModalOpen, setFormModalOpen] = useState(false);
  const [exportModalOpen, setExportModalOpen] = useState(false);
  const [editingVaccination, setEditingVaccination] = useState<VaccinationFemmeEnceinte | null>(null);
  ...
  const handleRowClick = (vaccination: VaccinationFemmeEnceinte) => {
    setSelectedVaccination(vaccination);
    setDetailModalOpen(true);
  };

  const handleEditClick = (vaccination: VaccinationFemmeEnceinte) => {
