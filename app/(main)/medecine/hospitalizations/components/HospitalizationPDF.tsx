    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>Fiche d'Hospitalisation - Médecine</Text>
          ...
          {hospitalization.leavingDate && (
            <Text style={styles.subtitle}>
              Date de sortie: {format(new Date(hospitalization.leavingDate), "dd/MM/yyyy HH:mm", { locale: fr })}
            </Text>
          )}
        </View>
        ...
        {/* Duration Information if leavingDate exists */}
        {hospitalization.leavingDate && hospitalization.createdAt && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>DURÉE D'HOSPITALISATION</Text>
            <Text style={styles.value}>
              Du {format(new Date(hospitalization.createdAt), "dd/MM/yyyy HH:mm", { locale: fr })} 
              au {format(new Date(hospitalization.leavingDate), "dd/MM/yyyy HH:mm", { locale: fr })}
            </Text>
            <Text style={styles.value}>
              Soit {Math.ceil(
